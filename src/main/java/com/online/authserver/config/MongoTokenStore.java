...
public class MongoTokenStore implements TokenStore {
    ...
    public OAuth2Authentication readAuthentication(String token) {
        ...
        MongoAccessToken mongoAccessToken = mongoOperations.findOne(query, MongoAccessToken.class);
    ...
    public void storeAccessToken(OAuth2AccessToken accessToken, OAuth2Authentication authentication) {
        ...
        mongoOperations.save(mongoAccessToken);
    }
    ...
    public void removeAccessToken(OAuth2AccessToken oAuth2AccessToken) {
        ...
        mongoOperations.remove(query, MongoAccessToken.class);
    }
    ...
    public OAuth2RefreshToken readRefreshToken(String tokenValue) {
        ...
        MongoRefreshToken mongoRefreshToken = mongoOperations.findOne(query, MongoRefreshToken.class);
    ...
    public void removeRefreshToken(OAuth2RefreshToken refreshToken) {
        Query query = new Query();
        query.addCriteria(Criteria.where(MongoRefreshToken.TOKEN_ID).is(extractTokenKey(refreshToken.getValue())));
        mongoOperations.remove(query, MongoRefreshToken.class);
    }
    ...
    private Collection<OAuth2AccessToken> findTokensByCriteria(Criteria criteria) {
        ...
        List<MongoAccessToken> accessTokens = mongoOperations.find(query, MongoAccessToken.class);
